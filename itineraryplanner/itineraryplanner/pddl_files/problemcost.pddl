(define (problem test-tourist)
	...
	(:constraints (and (preference VisitStp (at end (visited tourist1 stp))) (preference VisitLdneye (at end (visited tourist1 ldneye))) (preference VisitTrafalgsq (at end (visited tourist1 trafalgsq)))))
	(:metric minimize (+ (total-time) (* 1000 (+ (is-violated VisitStp) (is-violated VisitLdneye) (is-violated VisitTrafalgsq))))))